...
/* .... calcul de l'ordre dels angles de projeccio ... */          
calcul_indexs(ordre_proj,OS,NangOS);  

/* .... per cada angle, reomplir le segons ordre del angles determinats pels indexs ... */
for(k=0,index_1=0 ; k<Nang ; k++)
   for(i=0,index_2=ordre_proj[k]*Nbp; i<Nbp ; i++,index_1++,index_2++) le[index_1]=le2[index_2];
