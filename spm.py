...
class SPM:
    ...
    def normalize_mri(
        ...
        new_spm.write(
            design_type
            + "eoptions.biasreg = 0.01;\n"
            + design_type
            + "eoptions.biasfwhm = 60;\n"
            + design_type
            + "eoptions.tpm = {'"
            + template_image
            + "'};\n"
            ...
            + "eoptions.affreg = 'mni';\n"
            + design_type
            + "eoptions.reg = [0 0.001 0.5 0.05 0.2];\n"
            + design_type
            + "eoptions.fwhm = 0;\n"
            + design_type
            + "eoptions.samp = 3;\n"
    ...
    def create_mfile_contrast(
        self, mfile_name, spm_mat, contrast_name="contrast", contrast="[1 -1 0]"
    ):
...
class CAT12(object):
    ...
    def cat12seg_imgs(
        ...
        new_spm.write(
            ...
            + str(atlas_schaefer100)
            + ";\n"
        )
        new_spm.write(
            design_type + "Schaefer2018_200Parcels_17Networks_order = " + "0" + ";\n"
        )
        new_spm.write(
            design_type + "Schaefer2018_400Parcels_17Networks_order = " + "0" + ";\n"
        )
        new_spm.write(
            design_type + "Schaefer2018_600Parcels_17Networks_order = " + "0" + ";\n"
        )
        if not atlas_custom:
            new_spm.write(design_type + "ownatlas = " + "{''}" + ";\n")
        else:
            new_spm.write(
                design_type + "ownatlas = " + "{'" + atlas_custom + "'}" + ";\n"
            )
    ...
    def cat12seg_longit(
        ...
        new_spm.write(
            design_type
            + "registration.shooting.shootingtpm = {'"
            + template_volumes
            + "'};\n"
        )
        ...
        new_spm.write(
            design_type + "output.surface = " + str(surface_processing) + ";\n"
        )
    ...
    def create_cat12_new_model(
        ...
        new_spm.write(
            design_type
            + "check_SPM.check_SPM_zscore.do_check_zscore.use_unsmoothed_data = 1;\n"
            + design_type
            + "check_SPM_zscore.do_check_zscore.adjust_data = 1;\n"
            + design_type
            + "check_SPM.check_SPM_ortho = 1;\n"
        )
